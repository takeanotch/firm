  ...
  const services = [
    {
      id: 1,
      title: "Sécurité",
      description: "Services de sécurité compétitifs avec technologies avancées.",
      servicesList: ["Intervention", "Escorte", "Garde", "Transport", "Alarmes"],
      images: [
        { src: "/one.jpg", span: "col-span-2 row-span-2" },
        { src: "/two.jpg", span: "col-span-1 row-span-1" },
        { src: "/three.jpg", span: "col-span-1 row-span-1" }
      ],
      position: 'left'
    },
    {
      ...
      description: "Tenues professionnelles personnalisées pour tous secteurs.",
      features: ["Broderie", "Personnalisation", "Signalisation"],
      images: [
        { src: "/two.jpg", span: "col-span-3 row-span-1" },
        { src: "/four.jpg", span: "col-span-1 row-span-1" },
        { src: "/five.jpg", span: "col-span-2 row-span-1" }
      ],
      position: 'right'
    },
    {
      ...
      images: [
        { src: "/three.jpg", span: "col-span-2 row-span-1" },
        { src: "/six.jpg", span: "col-span-1 row-span-1" },
        { src: "/nine.jpg", span: "col-span-3 row-span-1" }
      ],
      position: 'left'
