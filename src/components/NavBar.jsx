...
// // import { ArrowBigDown, ArrowDown, ChevronDown, Menu, X, User, LogOut, Settings, Shield, Briefcase, Search } from 'lucide-react'
...
// //       <header
// //         ref={navRef}
// //         className="fixed top-0 left-0 w-full z-50 py-2 bg-white backdrop-blur-md border-b border-black/5"
// //       >
// //         {/* BRAND CENTER */}
...
// //             <img src='/logo.png' className='w-20 ' alt="Stone Consulting Logo"/>
...
// //                   <button className="px-4 py-2 rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors text-sm font-medium">
// //                     Connexion
// //                   </button>
// //                 </Link>
// //                 <Link href="/auth/signup">
// //                   <button className="px-4 py-2 rounded-lg bg-black text-white hover:bg-black/90 transition-colors text-sm font-medium">
// //                     S'inscrire
// //                   </button>
// //                 </Link>
// //               </div>
...
// //       <div
// //         ref={mobileMenuRef}
// //         className="fixed w-full inset-0 bg-white text-black z-40 flex flex-col items-center justify-center gap-8 text-xl"
// //         style={{ clipPath: 'circle(0% at 90% 5%)' }}
// //       >
// //         {/* MENU LINKS */}
// //         <Link href="/" onClick={() => setOpen(false)} className="hover:opacity-70 transition py-2">
// //           Accueil
// //         </Link>
// //         <Link href="/services" onClick={() => setOpen(false)} className="hover:opacity-70 transition py-2">
// //           Services
// //         </Link>
// //         <Link href="/blogs" onClick={() => setOpen(false)} className="hover:opacity-70 transition py-2">
// //           Blogs
// //         </Link>
// //         <Link href="/about" onClick={() => setOpen(false)} className="hover:opacity-70 transition py-2">
// //           À propos
// //         </Link>
...
// //                 {renderMobileAvatar()}
// //                 {shouldCompleteProfile() && (
// //                   <div className="absolute -top-1 -right-1 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs animate-pulse">
// //                     !
// //                   </div>
// //                 )}
// //               </div>
...
// //                   )}
// //                 </div>
// //                 <p className="text-sm text-gray-500 max-w-[250px] truncate mt-1">
// //                   {user?.email}
// //                 </p>
// //               </div>
// //             </div>
...
// //                   className="flex items-center justify-center gap-3 px-6 py-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors relative"
// //                 >
// //                   {link.icon}
// //                   <span className="font-medium">{link.label}</span>
// //                   {link.label === 'Compléter mon profil' && (
// //                     <span className="absolute -top-2 -right-2 text-xs bg-red-500 text-white px-2 py-1 rounded-full animate-pulse">
// //                       Nouveau
// //                     </span>
// //                   )}
// //                 </Link>
...
// //               <button
// //                 onClick={handleSignOut}
// //                 className="flex items-center justify-center gap-3 px-6 py-3 rounded-lg border border-red-200 text-red-600 hover:bg-red-50 transition-colors w-full"
// //               >
...
// //           </>
// //         ) : (
// //           /* BOUTONS AUTH NON CONNECTÉ MOBILE */
// //           <div className="flex flex-col gap-4 w-full max-w-xs">
// //             <Link href="/auth/login" onClick={() => setOpen(false)}>
// //               <button className="w-full py-3 rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors font-medium">
// //                 Connexion
// //               </button>
// //             </Link>
// //             <Link href="/auth/signup" onClick={() => setOpen(false)}>
// //               <button className="w-full py-3 rounded-lg bg-black text-white hover:bg-black/90 transition-colors font-medium">
// //                 S'inscrire
// //               </button>
// //             </Link>
// //           </div>
...
// //           className="flex items-center gap-3 px-4 py-3 rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors"
// //         >
// //           <ReactCountryFlag
// //             countryCode={selectedLanguage.countryCode}
// //             svg
